...
function execute(parameter) {
	Logger.getLogger().info("----- approveNodeProcess_kawari.js - execute -----");
    ...
    if (parameter.preNodeId == Constant.LO_NODE_APPLY){
    	mailid = Constant.LO_KAWARI_MAIL_ID_SUBMIT; 
    }else{
    	if(parameter.nodeId != Constant.LO_NODE_KIAN && parameter.preNodeResultStatus == "approve"){
    		proc_nm = "承認";
    	}
    }
    // 送信用パラメータ作成
